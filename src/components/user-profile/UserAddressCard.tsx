...
// import {getDefaultAddress} from "@/src/actions/addresses";
//
...
//   if (user) {
//     // @ts-ignore
//     setDefaultAddress(await getDefaultAddress(user.id))
//   }
//   return (
//       <>
...
//                     <Input type="text" defaultValue="509 401"/>
//                   </div>
//
//                   <div>
//                     <Label>State</Label>
//                     <Input type="text" defaultValue="Gujarat"/>
//                   </div>
//
//                   <div>
//                     <Label>City</Label>
...
//                     <Input type="text" defaultValue="Keval"/>
//                   </div>
//                 </div>
//               </div>
