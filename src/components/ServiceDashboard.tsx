...
import {getAddresses} from "@/src/actions/addresses";
import {countPartnerServices} from "@/src/actions/partner";
...
export default function DashboardPage({partnerdetails}:any) {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      {/* Header Section */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Welcome back, {partnerdetails.fullName}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data?.completedServicesCount}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data?.pendingServicesCount}</div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span>{partnerdetails.fullName}</span>
              </div>
              <div className="flex items-center space-x-2">
