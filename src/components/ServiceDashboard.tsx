...
export default function DashboardPage() {
  return (
    <div className="p-6 max-w-7xl mx-auto">
      {/* Header Section */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Welcome back, {mockProvider.name}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockProvider.totalServicesCompleted}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockProvider.pendingServices}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockProvider.rating} ★</div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span>{mockProvider.name}</span>
              </div>
              <div className="flex items-center space-x-2">
                <Calendar className="h-4 w-4 text-gray-500" />
                <span className="font-medium">Registered:</span>
                <span>{new Date(mockProvider.registrationDate).toLocaleDateString()}</span>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                ...
                <p>{mockProvider.email}</p>
              </div>
              <div>
                <span className="font-medium">Phone:</span>
                <p>{mockProvider.phone}</p>
              </div>
            </div>
          </CardContent>
        </Card>
