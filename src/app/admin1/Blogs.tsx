...
import { HiOutlineCamera } from 'react-icons/hi'; // Importing an icon for the button
...
export default function Blogs() {
  ...
  const [editingIndex, setEditingIndex] = useState<number | null>(null); // To track which blog is being edited
    ...
    if (image) {
      ...
      reader.onloadend = () => {
        ...
        if (editingIndex !== null) {
          ...
          updatedBlogs[editingIndex] = blogData; // Update existing blog
  ...
  const handleEdit = (index: number) => {
    ...
    setImagePreview(blog.image ?? null); // Set image preview
