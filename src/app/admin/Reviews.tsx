...
const AdminReviewsPage = () => {
  ...
  const [confirmDialogAction, setConfirmDialogAction] = useState<
    "display" | "hide" | null
  >(null);
  const [confirmDialogAction1, setConfirmDialogAction1] =
  ...
  const handleDisplayToggleConfirm1 = (
    review: Review,
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto">
        ...
        <Table>
          ...
          <TableBody>
            {reviews
              .filter((review) => {
                const fullName =
                  `${review.serviceRequest.firstName} ${review.serviceRequest.lastName}`.toLowerCase();
                const serviceName =
                  review.serviceRequest.service.name.toLowerCase();
                const providerName =
                  review.serviceRequest?.servicePartner?.fullName?.toLowerCase() ||
                  "";
                  ...
                  <TableCell>
                    <div className="flex  gap-2">
                      ...
                      <Button
                        ...
                        variant={
                          review.status == "true" ? "outline" : "default"
                        }
                        size="sm"
      ...
      <AlertDialog
        open={isConfirmDialogOpen1}
        onOpenChange={setIsConfirmDialogOpen1}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setIsConfirmDialogOpen1(false)}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
