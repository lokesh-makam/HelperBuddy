...
import { User, MapPin, Package, Users, LogOut, ChevronRight, ChevronLeft,Wallet } from "lucide-react";
                ...
                <div className="w-full max-w-screen-xl h-[calc(90vh-4rem)] bg-black/10 shadow-lg rounded-lg flex overflow-hidden">
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-4">
                            <NavItem icon={User} label="Profile" isOpen={isOpen} href="/profile" router={router} />
                            <NavItem icon={MapPin} label="Address" isOpen={isOpen} href="/profile/address" router={router} />
                            <NavItem icon={Package} label="Orders" isOpen={isOpen} href="/profile/orders" router={router} />
                            <NavItem icon={Users} label="Referral" isOpen={isOpen} href="/profile/referral" router={router} />
                            <NavItem icon={Wallet} label="Wallet" isOpen={isOpen} href="/profile/wallet" router={router} />
                            <NavItem icon={LogOut} label="Log Out" isOpen={isOpen} href="/profile/logout" router={router} />
                        </div>
                    </aside>
